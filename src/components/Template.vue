<template xmlns:v-on="http://www.w3.org/1999/xhtml">
  <div id="home">
    ...
    <div class=systemCenter>
      ...
      <div id="wenjuanBox">
        <div id="createWenjuanBox"style="height: 150px;padding: 3.7% 0"@click="createWenjuan()"
        ...
        <div id="wenjuanList" style="margin-top:0.7%">
          <li v-for="(wenjuan,index) in wenjuanList" class="userWenjuanBox" style="height: 150px" :key="index">
...
//        this.getFolderList();
    ...
    methods: {
      ...
      createWenjuan(wenjuanId) {
        this.$router.push({path: '/editTemplate', query: {wenjuanId: wenjuanId}})
      },
